...
public class RadioProgramDetailActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_radioprogram_detail);
		...
		if (savedInstanceState == null) {
			...
			getSupportFragmentManager().beginTransaction()
					.add(R.id.radioprogram_detail_container, fragment)
					.commit();
		}
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == android.R.id.home) {
			...
			//
			NavUtils.navigateUpTo(this, new Intent(this, RadioProgramListActivity.class));
			return true;
		}
